...
static const CGFloat DockGap = -30.0;
...
- (NSInteger)atlasIndex {
    switch (self.state) {
        ...
        case PetRap: return 4 * Columns + self.frame;
        case PetFailed: return 5 * Columns + self.frame;
        case PetSinging: case PetWaiting: return 6 * Columns + self.frame;
...
- (NSInteger)frameCount {
    switch (self.state) {
        ...
        case PetSinging: case PetWaiting: case PetReview: case PetAngry: return 6;
